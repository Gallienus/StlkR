...
document.getElementById('executeNext').addEventListener('click', () => {
    fetch('/api/robot/executeNext').then(r => r.json()).then(json => {
        if (json.success) {
            document.getElementById('executeNext').classList.remove('negative')
            document.getElementById('executeNext').classList.add('positive')
        } else {
            document.getElementById('executeNext').classList.remove('positive')
            document.getElementById('executeNext').classList.add('negative')
        }
    }).catch(console.log)
})